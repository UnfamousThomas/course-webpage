    ...
    if (document.getElementsByClassName("tom-slide") != null) { //Kui on Thomase slaidid siis vali need pildid
        images[0] = 'assets/imgs/Thomas/Simba1.jpg';
        images[1] = 'assets/imgs/Thomas/Simba2.jpg';
    } else if (document.getElementsByClassName("mia-slide") != null) { //Kui on Mia slaidid siis vali need pildid
        //images[0] = 'todo';
    } else if (document.getElementsByClassName("merlin-slide") != null) { //Kui on Merlini slaidid siis vali need pildid
        //images[0] = 'todo';
    }
...
function changeSlide() {
    document.getElementsByClassName("slide").src = images[i]; //Vaheta elemendi, mille id on "slide", "src" tagi väärtust
